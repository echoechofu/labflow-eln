...
从 [GitHub Releases](https://github.com/echoechofu/labflow-eln/releases/tag/v0.1.0) 下载 `LabFlow-0.1.0-Apple-Silicon.zip`，解压后将 `LabFlow.app` 拖入“应用程序”文件夹即可。本测试版仅支持 Apple Silicon（M1/M2/M3/M4 等）和 macOS 12 或更高版本。
